    ...
    fun main(){
        ...
        while (true) {
            ...
            when (readLine) {
                ...
                "/park_stats"->manager.parkStats()
                "/park_all_stats"->manager.parkAllStats()
                "/end" -> {
                    println("До свидания!")
                    break}
    ...
    const val string = "/start -- команда для приветстви,\n" +
            ...
            "/park_all_stats - возвращает сколько всего машин было припарковано за все время работы команды."